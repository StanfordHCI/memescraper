...
class HumourSpotCrawler(BaseCrawler):
    def __init__(self, *args, **kwargs):
        super(HumourSpotCrawler, self).__init__(source='humour_spot', *args, **kwargs)
        self.url = 'https://humourspot.com/category/meme/'
            ...
            for p in posts:
                try:
                    ...
                    images.append({
                        ...
                        #     time.strptime(t.attrs.get('datetime'), '%Y-%m-%dT%H:%M:%S+00:00')) - 16 * 3600
                    })

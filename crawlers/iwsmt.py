...
class IWSMTCrawler(BaseCrawler):
    def __init__(self, *args, **kwargs):
        super(IWSMTCrawler, self).__init__(source='iwsmt', *args, **kwargs)
        self.url = 'https://iwastesomuchtime.com'
    ...
    def get_feed(self, page=1):
        ...
        if response.status_code == 200:
            ...
            posts = soup.findAll("div", {"class": "blog-post"})
            for a in posts:
                try:
                    i = a.find('img', {"class": "img-post"})
                    images.append({

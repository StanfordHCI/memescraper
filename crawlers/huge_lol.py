...
class HugeLolCrawler(BaseCrawler):

    def __init__(self, *args, **kwargs):
        super(HugeLolCrawler, self).__init__(source='huge_lol', *args, **kwargs)
        self.url = 'https://hugelol.com/fresh'
        self.timeout = 16
    ...
    def get_feed(self, max_page=10):
        ...
        if response.status_code == 200:
            ...
            while has_next_page:
                response = requests.post("https://hugelol.com/cached/load/fresh.php",

...
class AstrologyMemesCrawler(BaseCrawler):
    def __init__(self, *args, **kwargs):
        super(AstrologyMemesCrawler, self).__init__(source='astrology_memes', *args, **kwargs)
        self.url = 'https://astrologymemes.com/?s=new'
    ...
    def get_feed(self, page=0, next_query=''):
        ...
        if page == 0:
            ...
            page_url = "https://astrologymemes.com/ajax/new_items?s=new&{}".format(next_query.strip("/?"))
    ...
    def run(self):
        ...
        while self.running:
            try:
                ...
                time.sleep(4)
                if not inserted or oldest_timestamp < BEGIN_CRAWL_SINCE:
                    next_page = 0
                    next_page_query = ''
                    time.sleep(120)

...
class StillCrackingCrawler(BaseCrawler):
    def __init__(self, *args, **kwargs):
        super(StillCrackingCrawler, self).__init__(source='still_cracking', *args, **kwargs)
        self.url = 'https://stillcracking.com/SC/funny/'

...
class OddStuffMagazineCrawler(BaseCrawler):
    def __init__(self, *args, **kwargs):
        super(OddStuffMagazineCrawler, self).__init__(source='odd_stuff_magazine', *args, **kwargs)
        self.url = 'https://oddstuffmagazine.com/'

    def get_feed(self, g):
        images = []
        response = requests.get(g.get("url"))
    ...
    def get_galleries(self):
        ...
        for li in list_items:
            yield {
                ...
                "url": li.find("a", {"class": "post-thumbnail"}).attrs.get("href")
            }

...
class LaughTardCrawler(BaseCrawler):
    def __init__(self, *args, **kwargs):
        super(LaughTardCrawler, self).__init__(source='laugh_tard', *args, **kwargs)
        self.url = 'https://www.laughtard.com/category/funny-pics/'
    ...
    def get_galleries(self):
        ...
        for li in list_items:
            yield {
                ...
                "url": li.find("a", {"class": "image_container"}).attrs.get("href")
            }

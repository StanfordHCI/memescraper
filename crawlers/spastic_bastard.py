...
class SpasticBastardCrawler(BaseCrawler):
    def __init__(self, *args, **kwargs):
        super(SpasticBastardCrawler, self).__init__(source='spastic_bastard', *args, **kwargs)
        self.url = 'https://www.spasticbastard.com/category/memes'

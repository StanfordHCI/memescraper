...
class DevHumorCrawler(BaseCrawler):
    def __init__(self, *args, **kwargs):
        super(DevHumorCrawler, self).__init__(source='dev_humor', *args, **kwargs)
        self.url = 'http://devhumor.com/category/memes'
    ...
    def get_feed(self, page=1):
        ...
        if response.status_code == 200:
            ...
            for a in posts:
                try:
                    i = a.find('img', {"class": "single-media"})
                    images.append({

...
class LoveForQuotesCrawler(BaseCrawler):
    def __init__(self, *args, **kwargs):
        super(LoveForQuotesCrawler, self).__init__(source='love_for_quotes', *args, **kwargs)
        self.url = 'https://loveforquotes.com/?s=new'
    ...
    def get_feed(self, page=0, next_query=''):
        ...
        if page == 0:
            ...
            page_url = "https://loveforquotes.com/ajax/new_items?s=new&{}".format(next_query.strip("/?"))

...
class UberHumorCrawler(BaseCrawler):
    def __init__(self, *args, **kwargs):
        super(UberHumorCrawler, self).__init__(source='uber_humor', *args, **kwargs)
        self.url = 'http://uberhumor.com/category/funny-pictures'

...
class TrendUSOMemesCrawler(BaseCrawler):
    def __init__(self, *args, **kwargs):
        super(TrendUSOMemesCrawler, self).__init__(source='trend_uso', *args, **kwargs)
        self.url = 'https://www.trenduso.com/latest/nsfw-exc'
    ...
    def get_feed(self, page=0):
        ...
        if response.status_code == 200:
            ...
            posts = soup.findAll("div", {"class": "tu-post-image"})
            for a in posts:
                try:
                    i = a.find('img')
                    images.append({
